cat > /opt/riskuw/backend/routers/file_security.py << 'EOF'
"""
...
def sanitise_extracted_fields(fields: dict) -> dict:
    ...
    return safe
EOF
echo "file_security.py created"</parameter>
<parameter name="description">Create file security module</parameter>